...
require "glimmer/src/xml_command_handlers" + "/../command_handler"
require "glimmer/src/xml_command_handlers" + "/models/node"
require "glimmer/src/xml_command_handlers" + "/models/depth_first_search_iterator"
require "glimmer/src/xml_command_handlers" + "/models/name_space_visitor"
