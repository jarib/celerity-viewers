...
require "glimmer/src/command_handlers" + "/models/observable_model"
require "glimmer/src/command_handlers" + "/models/model_observer"
require "glimmer/src/command_handlers" + "/models/widget_observer"
