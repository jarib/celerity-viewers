...
require "glimmer/src/command_handlers/models" + "/r_widget_listener"
require "glimmer/src/command_handlers/models" + "/r_runnable"

class RWidget
  require "glimmer/src/command_handlers/models" + "/r_widget_packages"
